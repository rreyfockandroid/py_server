...
const (
	PersonService_GetPerson_FullMethodName = "/api.PersonService/GetPerson"
)
...
type PersonServiceClient interface {
	GetPerson(ctx context.Context, in *Person, opts ...grpc.CallOption) (*PersonDetails, error)
}
...
func (c *personServiceClient) GetPerson(ctx context.Context, in *Person, opts ...grpc.CallOption) (*PersonDetails, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PersonDetails)
...
type PersonServiceServer interface {
	GetPerson(context.Context, *Person) (*PersonDetails, error)
...
func (UnimplementedPersonServiceServer) GetPerson(context.Context, *Person) (*PersonDetails, error) {
